  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      ...
      <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person prefix"></i>
            <input name="Services" id="Services" type="text" data-error=".errorTxt2">
            <label for="Services" class="center-align">Services</label>
      <div class="errorTxt5">
      ...
      <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person prefix"></i>
            <input name="address" id="address" type="text" data-error=".errorTxt2">
